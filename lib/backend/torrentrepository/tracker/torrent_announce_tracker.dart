...
///
  ...
  ///         // The parameters that need to be returned can be determined according to uri and infoHash. That is to say, in fact, this provider can be used in multiple
  ///         // Used with TorrentTracker.
  ///         var someport;
  ///         if(infoHash..... ){
  ...
  void _fireAnnounceError(Tracker tracker, dynamic error) {
    ...
    int retime = _retryAfter * pow(2, times) as int;
