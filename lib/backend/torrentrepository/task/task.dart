...
import '../dht/dht_base.dart';
import '../model/torrent.dart';
import '../tracker/torrent_tracker_base.dart';
import '../tracker/tracker/peer_event.dart';
import '../tracker/tracker/tracker.dart';
...
class _TorrentTask implements TorrentTask, AnnounceOptionsProvider {
  ...
  String?
      _peerId; // This is the id of the generated local peer, which is different from the id of the peer class
  ...
  Future stop([bool force = false]) async {
    ...
    dynamic tempHandler = Set<Function>.from(_stopHandlers);
    await dispose();
