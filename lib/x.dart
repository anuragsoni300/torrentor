...
/// [MyPopupMenuItem]), or no value at all (for example, [PopupMenuDivider]).
///
/// See also:
///
...
// item lines up with the center of its MyPopupMenuButton.
...
/// shows a popup menu, consider using [MyPopupMenuButton].
///
/// A [CheckedMyPopupMenuItem] is kMinInteractiveDimension pixels high, which
...
class CheckedMyPopupMenuItem<T> extends MyPopupMenuItem<T> {
  ...
  MyPopupMenuItemState<T, CheckedMyPopupMenuItem<T>> createState() =>
      _CheckedMyPopupMenuItemState<T>();
}

class _CheckedMyPopupMenuItemState<T>
    extends MyPopupMenuItemState<T, CheckedMyPopupMenuItem<T>>
...
class _PopupMenuRouteLayout extends SingleChildLayoutDelegate {
  ...
  // The index of the selected item, or null if MyPopupMenuButton.initialValue
  // was not specified.
...
typedef MyPopupMenuItemBuilder<T> = List<PopupMenuEntry<T>> Function(
