...
import '../../bencode_base.dart' as bencoder;
...
///  2 characters are enough as they cover 2^16 outstanding queries.
List<int>? queryMessage(
    String? transactionId, String? method, Map? arguments) {
...
List<int>? getPeersResponse(
    String? transactionId, String? nodeId, String? token,
