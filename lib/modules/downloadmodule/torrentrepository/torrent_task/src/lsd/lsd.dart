...
class LSD {
  static const String LSD_HOST_STRING = '239.192.152.143:6771\r\n';

  static final InternetAddress LSD_HOST =
      InternetAddress.fromRawAddress(Uint8List.fromList([239, 192, 152, 143]));
  static const LSD_PORT = 6771;

  static const String ANNOUNCE_FIREST_LINE = 'BT-SEARCH * HTTP/1.1\r\n';
  ...
  void start() async {
    ...
    _socket?.listen((event) {
      if (event == RawSocketEvent.read) {
        ...
        var str = datas != null ? String.fromCharCodes(datas) : null;
  ...
  Future<void> _announce() async {
    ...
    _timer = Timer(const Duration(seconds: 5 * 60), () => _announce());
  }
